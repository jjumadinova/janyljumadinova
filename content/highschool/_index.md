...
layout: page
title: High School
subtitle: GameCraft - Build Your Own Web Game
...
**Learn by Building:** Every session, you create something that works.
**Progress Together:** Each lesson builds on the previous one.
**Real Tools:** You use the same tools professional developers use.
