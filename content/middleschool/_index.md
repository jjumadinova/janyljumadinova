...
### [Session 1: Introduction to micro:bit](/middleschool/session1/)
**Build:** Your first interactive programs on the micro:bit  
**Learn:** MakeCode editor, LED display, buttons, sensors, variables  
**No prerequisites** — we start from zero!

---

### [Session 2: Sensing the World with IR Sensors](/middleschool/session2/)
**Build:** An obstacle alert system using an IR sensor  
**Learn:** Wiring a 3-pin sensor, digital vs. analog readings, conditional logic  
